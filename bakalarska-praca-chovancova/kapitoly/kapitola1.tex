...
% The table below shows some important differences between Canvas and SVG:
 ...
 \begin{tabular}{|p{7.4cm}|p{7.4cm} |}
 	...
 	\hline Obmedzené možnosti na vykresľovanie - pri zväčšovaní obrázka sa zhoršuje kvalita & Vhodné pre aplikácie s veľkými plochami na vykresľovanie\\ 
   \hline Bitmap raster, po vykreslení nemáme objektovú reprezentáciu obrázku & Vektorový objektový model zostáva\\  
...
\begin{itemize}
    ...
    \item animatron - online editor, umožnuje vytvoriť HTML5 animácie, a následne vyexportovať do SVG SMIL animácie, dostupný na: \url{https://www.animatron.com/}
...
Medzi hlavné výhody knižnice patrí to, že má ľahko čitateľnú syntax. Umožňuje animovanie veľkosti, pozície, transformácie, farby. Má modulárnu štruktúru, čo umožňuje používanie rôznych rozšírení. Existuje množstvo užitočných pluginov dostupných na internete. \cite{svgjs}
